...
#print('total of all loans', total_value_of_issued_loans)
...
3. Write a conditional statement (an if-else statement) to decide if the present 
value represents the loan's fair value.
    a. If the present value of the loan is greater than or equal to the cost, then print a 
...
# YOUR CODE HERE!
#def inexpesnive_loan_finder(loan):
 #   for loan in loans:
  #      if loan <= 500:
   ##        inexpensive_loans.append(loans)
#         else:
#             loans("loan_price").ignore
# inexpensive_loans = inexpesnive_loan_finder(loans)
for loan in loans:
...
# and each row of `loan.values()` from the `inexpensive_     loans` list.
# YOUR CODE HERE!
